...
# 📖 [Survey-Review] <a name="about-project"></a>



**This is a project we did during the Microverse Admission Trials. This project will help one do a survey and collect the neccessary information needed to accomplish a particular task. The project will be of great help and personally it made apply more knowledge very i,portant for my career growth.**
...
- **This can be used to do any survey**
